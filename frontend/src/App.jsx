...
function App() {
 ...
 const handleSubmit=async (event)=> {
    ...
    const response = await axios.post("https://aichatbot-wn12.onrender.com/aichatbot", { message: input })
    console.log(response.data.response)
    setChat((prev) =>{return [...prev, { ai: response.data.response }]})
    setInput("")
    const storeResponse = await axios.post("https://aichatbot-wn12.onrender.com/store", { question: input, answer: response.data.response })
